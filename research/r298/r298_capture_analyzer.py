#!/usr/bin/env python3
"""R298 offline analyzer for a future sealed R291/R288 V25 residual capture.
...
def analyze_capture(capture_dir: Path, expected_panel: Path,
    ...
    return {
        "schema": "arc.whitebox.r298.capture_analysis.v1",
...
def main() -> int:
    ...
    try:
        ...
        raise SystemExit(f"R298 analyzer error: {exc}") from exc
