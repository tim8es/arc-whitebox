...
SPEC = importlib.util.spec_from_file_location("r298_analyzer", HERE / "r298_capture_analyzer.py")
assert SPEC and SPEC.loader
a = importlib.util.module_from_spec(SPEC)
sys.modules["r298_analyzer"] = a
...
def main() -> int:
    checks = {}
    with tempfile.TemporaryDirectory(prefix="r298-selfcheck-") as td:
        root = Path(td)
